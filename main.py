...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def open_dir(self):
        ...
        if self.dir_name != None and self.dir_name != '':
            ...
            self.OpenDirBtn.setChecked(False)
    ...
    def resetBasicInfo(self):
        ...
        print("[Success] Reset Basic Information Form.")
    ...
    def get_coordinates(self):
        # print(self.canvas.mouseReleaseEvent)
    ...
    def addObjToList(self):
        ...
        if len(bboxes) < 6:
            ...
            self.emsg.showMessage(
                "The labeled frame doesn't include crash start frame.")
            return
        elif self.crashStartFrame_lineEdit.text() != max(bboxes.keys()):
            self.emsg.showMessage(
                "Do not label the frame after crash start frame.")
            return
